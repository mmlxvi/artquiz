$(document).ready(function() {
	...
	var qOne = new qArray("This American artist rose to fame in the 1950s for his mixed-media pieces that anticipated the Pop Art movement. In 1983, he won a Grammy Award for his art design on the Talking Heads album, <span class='italic'>Speaking in Tongues.</span>", 
	...
	var qTwo = new qArray("This piece, titled <span class='italic'>Bananas</span>, was one in a series of collaborative paintings by Andy Warhol and this neo-expressionist painter who first gained notoriety for his graffiti in the Lower East Side of Manhattan.", "Who is the other painter?", 
	...
	var qThree = new qArray("She was an influential American abstract expressionist painter in the second half of the 20th century, as was her husband, who was the more famous of the two. The work seen here, <span class='italic'>Night Creatures</span>, was completed in 1965.", "Who painted this?", "Helen Frankenthaler",
				 "Lee Krasner", "Georgia O'Keeffe", "Frida Kahlo", "Lee Krasner", "It was Lee Krasner. One of Krasner's teachers once remarked that her work was \"so good you would not know it was painted by a woman.\"", 'nightcreatures.jpg');

	var qFour = new qArray("This Mexican painter was portrayed by Rubén Blades in the 1999 film <span class='italic'>Cradle Will Rock</span>, and by Alfred Molina in Julie Taymor's Frida Kahlo biopic in 2002. The painter was most famous for his murals, which prominently featured socialist themes and aspects of Mexican culture.", "Who is the painter?",
	...
	var qFive = new qArray("Mark Rothko was an Abstract Expressionist painter whose signature works are large-scale paintings of  emotionally evocative colored rectangles. In 1964, he was commissioned to create a meditative space filled with his paintings. Rothko committed suicide in 1970 and did not live to see the chapel completed.", "The Rothko Chapel is located in what American city?", "Houston", "San Francisco", "Baltimore", "New Haven", "Houston", "Composer Morton Feldman wrote a piece inspired by his visit to the chapel in Houston, TX.", 'white-center.jpg');

	var qSix = new qArray("This American painter was born in 1952. He studied at CalArts and rose to fame in New York in the 1980s. His paintings often juxtapose seemingly unrelated images appropriated from popular culture and art history. In 1995 he directed the feature film <span class='italic'>Search and Destroy</span>, which starred Christopher Walken and Dennis Hopper.", "Who painted this?", "Julian Schnabel", "Jeff Koons",
	...
	var	qEight = new qArray("This prolific Spanish painter is known for co-founding the Cubist movement. The painting shown here, <span class='italic'>La Lecture de la Lettre (Reading the Letter)</span>, was created circa 1921 during his transition from Cubism to Classicism.", "Who painted this?", "George Braque", "Piet Mondrian", "Willem de Kooning",
	...
	var qNine = new qArray("Willem de Kooning (1904 – 1997) was a Dutch American abstract expressionist. The work shown here, <span class='italic'>Pink Angels</span>, is the final painting in his first series devoted to images of women.", "In what year was this painting most likely completed?",
	...
	function loadNext(qArray){
    	...
    	$('#info').html(qArray.information); /* changed .text to .html for the italics in the questions */
